...
describe('EventDetailComponent', () => {
  ...
  const mockEvent: any = {
    ...
    name: 'Concert Test',
    description: 'Description du concert test qui fait plus de 400 caractères pour tester la troncature. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident.',
    url: 'http://test.com',
    venue: {
      name: 'Salle de test',
      city: 'Paris',
  ...
  it('should format event start time correctly', () => {
    component.event.set(mockEvent);
    const startTime = component.getEventStartTime();
    expect(startTime).toBe('20:00');
  });
